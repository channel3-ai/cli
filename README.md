...
The official CLI for the [Channel3 REST API](https://docs.trychannel3.com).
...
```sh
go install 'github.com/stainless-sdks/public-sdk-cli/cmd/public-sdk@latest'
```
...
- `--api-key` (can also be set with `CHANNEL3_API_KEY` env var)
...
You can link the CLI against a different version of the Channel3 Go SDK
